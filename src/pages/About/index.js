...
const About = ({ navigation }) => (
  <View style={styles.page}>
    ...
    <View style={styles.container}>
      ...
      <Text style={styles.subtitle}>Kontak Developer : </Text>
      <View style={styles.content}>
        <Text style={styles.job}>1. Adhri (Programmer Front End Developer)</Text>
        <Gap height={7} />
        <ListSocialMedia icon="google" label="Email" value="adhri.adly@gmail.com" color={Colors.TintPrimary} />
      ...
      <View style={styles.content}>
        ...
        <Gap height={7} />
        <ListSocialMedia icon="google" label="Email" value="agusrukanda64@gmail.com" color={Colors.TintPrimary} />
